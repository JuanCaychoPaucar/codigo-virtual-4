...
// FORMA CORECTA DE COPIAR UN OBJETO EN OTRA VARIABLE
// Tambien existe un operador rest(...) para los objetos
// para ello usamos las llavesen vez de [] como en los arreglos
...
const modificarTitulo = (objetoPelicula, nuevoTitulo) => {
    // estamos retornando una copia de todas las propiedades del objetoPelicula
    // sin embargo estamos reemplazando el valor de la propiedad "title"
    // incluso podemos agregar NUEVOS ATRIBUTOS
    return {
        ...objetoPelicula,
        title: nuevoTitulo,
        atributo: "algo",
